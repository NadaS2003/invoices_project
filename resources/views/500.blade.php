...
<link href="{{secure_asset('assets/plugins/typicons.font/typicons.css')}}" rel="stylesheet">
<!---Internal Feather css-->
<link href="{{secure_asset('assets/plugins/feather/feather.css')}}" rel="stylesheet">
...
@section('content')
		...
		<div class="main-error-wrapper  page page-h ">
			<img src="{{secure_asset('assets/img/media/500.png')}}" class="error-page" alt="error">
